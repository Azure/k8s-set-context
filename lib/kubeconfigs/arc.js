...
exports.runAzKubeconfigCommandBlocking = exports.runAzCliCommand = exports.getArcKubeconfig = void 0;
...
const KUBECONFIG_LOCATION = path.join(RUNNER_TEMP, `arc_kubeconfig_${Date.now()}`);
/**
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (method) {
            case method_1.Method.SERVICE_ACCOUNT:
                ...
                return yield runAzKubeconfigCommandBlocking(azPath, [
                    "connectedk8s",
                    "proxy",
                    "-n",
                    clusterName,
 ...
 */
function runAzKubeconfigCommandBlocking(azPath, args) {
    return __awaiter(this, void 0, void 0, function* () {
