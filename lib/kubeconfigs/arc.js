...
exports.runAzCliCommandBlocking = exports.runAzCliCommand = exports.getArcKubeconfig = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (method) {
            case method_1.Method.SERVICE_ACCOUNT:
                ...
                return yield runAzCliCommandBlocking(azPath, `connectedk8s proxy -n ${clusterName} -g ${resourceGroupName} --token ${saToken} -f-`);
            case method_1.Method.SERVICE_PRINCIPAL:
                return yield runAzCliCommandBlocking(azPath, `connectedk8s proxy -n ${clusterName} -g ${resourceGroupName} -f-`);
            case undefined:
 ...
 */
function runAzCliCommandBlocking(azPath, command) {
    return __awaiter(this, void 0, void 0, function* () {
        const process = child_process_1.spawn(`${azPath} ${command}`, {
            detached: true,
        });
        let output = "";
...
exports.runAzCliCommandBlocking = runAzCliCommandBlocking;
