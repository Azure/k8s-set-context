...
exports.sleep = exports.runAzCliCommand = exports.getArcKubeconfig = void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (method) {
            case method_1.Method.SERVICE_ACCOUNT:
                ...
                runAzCliCommand(azPath, `connectedk8s proxy -n ${clusterName} -g ${resourceGroupName} --token ${saToken} -f-`, runAzCliOptions);
                yield sleep(AZ_CONNECTED_PROXY_TIMEOUT_MS); // az connectedk8s proxy never returns so we need move on after a set amount of time
                return kubeconfig;
            case method_1.Method.SERVICE_PRINCIPAL:
                runAzCliCommand(azPath, `connectedk8s proxy -n ${clusterName} -g ${resourceGroupName} -f-`, runAzCliOptions);
                yield sleep(AZ_CONNECTED_PROXY_TIMEOUT_MS); // az connectedk8s proxy never returns so we need move on after a set amount of time
                return kubeconfig;
            case undefined:
